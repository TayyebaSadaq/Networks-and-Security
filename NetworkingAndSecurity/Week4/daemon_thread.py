...
if __name__ == "__main__":
    ...
    # The 'daemon' flag is set to True, so this thread is a daemon thread.
    # It won't prevent the program from exiting if the main program is done.
    # If the main program exits before this thread completes, the thread will be abruptly terminated.
